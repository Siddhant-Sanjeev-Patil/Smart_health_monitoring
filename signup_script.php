...
// checking the submitted text box for null value by giving there name.
  ...
  else
  {
      ...
      $sql = "INSERT INTO users (firstname,lastname,contact_no,email,address,password,city,state) VALUES ('$fir_name','$last_name','$u_mobile','$u_eid','$u_add','$u_password','$u_city','$u_state')";
